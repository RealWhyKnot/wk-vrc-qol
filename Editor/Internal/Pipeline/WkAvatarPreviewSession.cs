...
using UnityEngine;
using WhyKnot.AvatarQol.Internal.Reflection;

namespace WhyKnot.AvatarQol.Internal.Pipeline {

    public sealed class WkAvatarPreviewSession : IDisposable {

        private const string PrefsSourceGlobalId  = "WhyKnot.AvatarQol.Internal.PreviewSession.SourceGlobalId.";
        private const string PrefsSourceWasHidden = "WhyKnot.AvatarQol.Internal.PreviewSession.SourceWasHidden.";
